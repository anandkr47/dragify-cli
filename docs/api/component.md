...
To get more about this feature read: [https://github.com/dragifyJS/dragifyjs/issues/1936][10]
...
*   `opts` **[Object][2]** Options (optional, default `{}`)
    ...
    *   `opts.withProps` **[Boolean][3]?** Include component properties as `data-dragify-*` attributes. This allows you to have re-importable HTML.
...
[6]: https://github.com/dragifyJS/dragifyjs/blob/master/src/utils/Resizer.ts
...
[10]: https://github.com/dragifyJS/dragifyjs/issues/1936
