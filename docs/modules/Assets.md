...
<p align="center"><img src="http://dragifyjs.com/img/sc-dragifyjs-assets-1.jpg" alt="dragifyJS - Asset Manager" align="center"/></p>

In this section, you will see how to setup and take the full advantage of built-in Asset Manager in dragifyJS. The Asset Manager is lightweight and implements just an `image` in its core, but as you'll see next it's easy to extend and create your own asset types.
...
Check the full list of available options here: [Asset Manager Config](https://github.com/dragifyJS/dragifyjs/blob/master/src/asset_manager/config/config.ts)
...
If you want a complete list of available properties check out the source [AssetImage Model](https://github.com/dragifyJS/dragifyjs/blob/dev/packages/core/src/asset_manager/model/AssetImage.ts)
...
::: warning
This section is referring to dragifyJS v0.17.26 or higher
:::
  ...
  assetManager: {
    ...
    custom: {
      open(props) {
        ...
        // this state back to the editor, otherwise dragifyJS will think
...
am.addType('svg-icon', {
  view: {
    ...
    // https://github.com/dragifyJS/dragifyjs/blob/dev/packages/core/src/asset_manager/view/AssetView.ts
    getPreview() {
...
am.addType('image', {
  ...
  view: {
    ...
    // https://github.com/dragifyJS/dragifyjs/blob/dev/packages/core/src/asset_manager/view/AssetImageView.ts
    onRemove(e) {
      e.stopPropagation();
