...
<p align="center"><img :src="$withBase('/style-manager.jpg')" alt="dragifyJS - Style Manager"/></p>

The Style Manager module is responsible to show and update style properties relative to your [Components]. In this guide, you will see how to setup and take full advantage of the built-in Style Manager UI in dragifyJS.
...
:::
::: warning
This guide is referring to dragifyJS v0.18.1 or higher
:::
...
Check the full list of available options here: [Style Manager Config](https://github.com/dragifyJS/dragifyjs/blob/master/src/style_manager/config/config.ts)
...
In order to speed up the Style Manager configuration, dragifyJS is shipped with a set of already defined common CSS properties which you can reuse and extend.
...
<style>
  ...
  .dragify-pn-views-container, .dragify-pn-views {
    width: 280px;
  }
  .dragify-pn-options {
    right: 280px;
