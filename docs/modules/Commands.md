...
- [`core:open-code`](https://github.com/dragifyJS/dragifyjs/blob/dev/packages/core/src/commands/view/ExportTemplate.ts) - Open a default panel with the template code
