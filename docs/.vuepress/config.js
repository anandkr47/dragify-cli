...
const baseUrl = 'https://dragifyjs.com';
const subDivider = ' ‍  ‍  ‍ ';

module.exports = {
  title: 'dragifyJS',
  description: 'dragifyJS documentation',
  base: '/docs/',
  ...
  head: [
    ...
    [
      'link',
      {
        rel: 'stylesheet',
        href: isDev
          ? `${devPath}/dist/css/dragify.min.css`
          : `${baseUrl}/assets/styles/dragifyjs/dragify.min.css?${version}`,
      },
    ],
    [
      'script',
      { src: isDev ? `${devPath}/dragify.min.js` : `${baseUrl}/assets/scripts/dragifyjs/dragify.min.js?${version}` },
    ],
  ],
  localesSKIP: {
    '/': {
    ...
    '/it/': {
      lang: 'it-IT',
      description: 'dragifyJS documentazione',
    },
  },
  themeConfig: {
    editLinks: true,
    ...
    locales: {
      ...
      '/it/': {
        selectText: 'IT',
        label: 'Italiano',
        nav: [{ text: 'Supportaci', link: 'https://opencollective.com/dragifyjs' }],
    ...
    nav: [
      ...
      { text: 'Support Us', link: 'https://opencollective.com/dragifyjs' },
      { text: 'Twitter', link: 'https://twitter.com/dragifyjs' },
    ],
    sidebar: {
      '/api/': [
        '',
      ...
      '/': [
        ...
        },
        {
          ...
          children: [
            ...
            ['/guides/Telemetry', 'dragifyJS Telemetry'],
          ],
        },
      ],
    },
